...
<a href="index.php?pid=students&func=add"><img src="../images/buttons/add.png" border="0"><br/>اضافه کردن دانشجوی جدید</a><br />
<form method="POST">
	<input type="hidden" name="step" value="2">
	<table class="tables" width="80%">
		<tr class="tablesheader">
			<td colspan="4">جستجوی دانشجو</td>
		</tr>
		<tr>
		...
		<tr>
			<td align="left"><b>کد دانشجو:</b></td>
			<td><input type="text" name="id" size="20"></td>
			<td align="left"><b>فعال/غیرفعال:</b></td>
			<td>
...
<?php
include("students.list.step2.php");  
?>  