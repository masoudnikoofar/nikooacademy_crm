...
<a href="index.php?pid=teachers&func=add"><img src="../images/buttons/add.png" border="0"><br/>اضافه کردن استاد جدید</a><br />
<form method="POST">
	<input type="hidden" name="step" value="2">
	<table class="tables" width="80%">
		<tr class="tablesheader">
			<td colspan="4">جستجوی استاد</td>
		</tr>
		<tr>
...
<?php
include("teachers.list.step2.php");  
?>  