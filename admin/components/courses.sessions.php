...
if ($_POST['step']=="2")
{
    ...
    for ($i=0;$i<$class_count;$i++)
    {
        ...
        $db->query("insert into courses_sessions set
        course_id='".$course_id."',
...
<!-- view -->
<?php
$db->query("select * from courses_sessions where course_id='".$course_id."' order by class_date");
$res=$db->result();
?>
...
$course_session_no=$row['session_no'];
?>
<form method="post">
    <input type="hidden" name="step" value="1">
    اولین روز کلاس:<input type="text" name="class_first_date" value="<?php echo $course_start_date; ?>" size="10"><?php calendar("class_first_date"); ?>
    تعداد جلسات: <input type="text" name="class_count" value="<?php echo $course_session_no; ?>" size="2">
