...
<form method="POST" enctype="multipart/form-data">
	...
	<table class="tables" width="80%">
		<tr class="tablesheader"><td valign="top" colspan="4">اضافه کردن استاد جدید</td></tr>
		<tr class="odd">
		...
		<tr class="odd">
			...
			<td valign="top" align="left"><b>سابقه موسیقی:</b></td>
		...
		<tr>
			...
			<td valign="top" align="left"><b>اطلاعات حساب:</b></td>
			<td valign="top"><textarea  rows="3" name="account_info" cols="30" id="account_info"><?php echo $_POST['account_info']; ?></textarea></td>			
		</tr>
		<tr class="odd">
			<td valign="top" align="left"><b>تاریخ شروع همکاری:</b></td>
			<td valign="top"><input type="text" name="cooperate_date" size="20" value="<?php echo $_POST['cooperate_date']; ?>" dir="ltr"><?php calendar("cooperate_date"); ?></td>
