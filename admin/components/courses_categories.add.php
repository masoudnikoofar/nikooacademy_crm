...
if ($_POST[step]=="2")
{
    ...
    $db->query("insert into courses_categories set
		title='".$title."',
		parent_id='".$parent_id."',
...
<table width="100%" class="tables" >
	<tr><td colspan="2" class="tablesheader">اضافه کردن گروه جدید</td></tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="moodle_shortname_pattern" id="moodle_shortname_pattern"></td>
	</tr>
